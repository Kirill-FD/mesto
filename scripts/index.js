...
const popup = document.querySelector('.popup__form_profile');
...
const forma = document.querySelector('.popup__form_card');
...
const formCard = document.querySelector('.form__create_card');
