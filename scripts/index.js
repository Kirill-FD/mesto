...
const popup = document.querySelector('.popup__forma_add_profile');
...
const popupContainer = popup.querySelector('.form__add_new_profile');
...
const forma = document.querySelector('.popup__forma_add_card');
...
const formCard = document.querySelector('.form__add_new_card');
